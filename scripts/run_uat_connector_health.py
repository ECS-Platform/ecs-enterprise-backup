...
REMEDIATION: dict[str, str] = {
    ...
    "teams_graph": "Set ECS_GRAPH_TENANT_ID, ECS_GRAPH_CLIENT_ID, ECS_GRAPH_CLIENT_SECRET (and ECS_TEAMS_TEAM_ID for messages).",
    "outlook_graph": "Set ECS_GRAPH_TENANT_ID, ECS_GRAPH_CLIENT_ID, ECS_GRAPH_CLIENT_SECRET, ECS_OUTLOOK_USER_ID.",
