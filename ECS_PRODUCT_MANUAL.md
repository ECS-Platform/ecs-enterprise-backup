...
**66 screenshots** of the running platform (demo mode) are captured under `docs/product_manual/screenshots/`. The full index with descriptions and section references is in **`ECS_SCREENSHOTS_INDEX.md`**. A few anchors:
