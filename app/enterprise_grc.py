...
from app.demo_metrics import BUSINESS_UNITS, display_framework_maturity
...
def build_cmdb_inventory(role: str = "owner") -> dict:
    from app.framework_catalog import APPLICATIONS, SERVERS
...
def build_governance_analytics_module(role: str = "cio") -> dict:
    ...
    from app.demo_metrics import REJECTION_TRENDS, SLA_TRENDS, ENTERPRISE_MONTHLY_TRENDS
