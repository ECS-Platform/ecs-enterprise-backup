...
from app.operations_catalog import BANKING_APPLICATIONS, MODULE_STATUSES, OWNERS
...
def build_module_workspace(module: str, role: str = "owner") -> dict:
    ...
    if module == "comparison":
        from app.comparison_engine import COMPARE_SCOPES, TIME_RANGES
    ...
    if module == "lifecycle":
        from app.governance_lifecycle_engine import LIFECYCLE_APPS
