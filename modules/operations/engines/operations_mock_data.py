...
from modules.operations.engines.operations_catalog import (
    ALL_FRAMEWORKS,
...
def generate_integration_events(count: int = 120) -> list[dict]:
    from modules.operations.engines.integration_health_engine import build_integration_health_rows
...
def build_operations_dataset(module: str, role: str = "owner") -> dict:
    ...
    if module == "upload":
        from modules.executive_overview.engines.enterprise_mock_service import session_upload_records
