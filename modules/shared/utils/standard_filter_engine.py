...
from modules.executive_overview.engines.demo_metrics import BUSINESS_UNITS, REUSE_METRICS
from modules.executive_overview.engines.enterprise_mock_service import build_pan_india_posture, build_reuse_mappings
from modules.governance.engines.governance_mock_data import health_enrichment, OWNERS
from modules.governance.engines.analytics_module import enterprise_dashboard
from modules.shared.services.role_filter_scope import apply_role_scope, scope_reuse_for_role, scope_reports_for_role
...
def _enterprise_dataset(role: str) -> dict:
    from modules.executive_overview.engines.executive_analytics_engine import build_banking_bu_analytics
...
def _reports_dataset(role: str) -> dict:
    from modules.executive_overview.engines.reporting_module import list_report_history, list_report_observation_rows, list_reports, list_scheduled_reports
...
def _exceptions_dataset(role: str) -> dict:
    from modules.governance.engines.exception_state_engine import get_all_exceptions
...
def _search_dataset(role: str) -> dict:
    ...
    from modules.governance.engines.governance_mock_data import search_defaults
...
def _risk_register_dataset(role: str) -> dict:
    from modules.enterprise_grc.engines.enterprise_grc import build_risk_register
...
def _regulatory_dataset(role: str) -> dict:
    from modules.enterprise_grc.engines.enterprise_grc import build_regulatory_mapping
