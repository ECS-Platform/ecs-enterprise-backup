...
_MODULE_GROUPS: dict[str, str] = {
    ...
    "evidence_dashboard": "Operations",
    "evidence_story": "Operations",
    "audit_repository": "Operations",
    "predefined_queries": "Operations",
    "ai_ops_assistant": "Operations",
    "reuse": "Governance",
...
_SCREEN_LABELS: dict[str, str] = {
    ...
    "evidence_dashboard": "Evidence Dashboard",
    "evidence_story": "Evidence Reuse",
    "ai_ops_assistant": "AI Ops Assistant",
...
def _screen_href(page_module: str, q: str) -> str:
    routes = {
        ...
        "evidence_dashboard": f"/mvp/evidence-dashboard?{q}",
        "evidence_story": f"/mvp/evidence-story?{q}",
        "ai_ops_assistant": f"/mvp/ai-ops-assistant?{q}",
        "reuse": f"/mvp/reuse?{q}",
