...
from modules.governance.engines.analytics_module import _app_for, audit_preparation_checklist, completeness_report
...
def build_upload_missing_view(
    ...
    from modules.governance.engines.missing_evidence_engine import get_missing_record
...
def process_upload_missing(
    *,
    ...
    from modules.shared.services.role_permissions import can_upload_evidence, permission_denied_message

    if not can_upload_evidence(role):
        return permission_denied_message("upload or replace evidence")
    from modules.governance.engines.missing_evidence_engine import apply_upload
...
def build_mock_audit_view(role: str, user: str, executed: bool = False, return_module: str = "audit_prep") -> dict:
    from modules.governance.engines.audit_prep_data import BANKING_APPS, build_audit_prep_view
    from modules.governance.engines.governance_relational_model import FRAMEWORK_GRAPHS
