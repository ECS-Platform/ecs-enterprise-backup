...
from modules.shared.services.audit_trail import get_audit_trail, get_approval_history, get_version_history
from modules.operations.engines.evidence_repository import get_reuse_graph
from modules.frameworks.engines.framework_catalog import FRAMEWORK_CATALOG, get_framework_controls, get_all_evidence_records, resolve_framework_name
...
def _workflow_state(key: str) -> dict:
    ...
    if key in ecs_state.rejected_controls:
        ...
        from modules.operations.engines.resubmission import stage_label
