...
from modules.shared.services.audit_trail import get_approval_history
...
def audit_preparation_checklist():
    from modules.governance.engines.operational_workflows import adjusted_missing_count, adjusted_readiness_pct, enrich_upcoming_audits
