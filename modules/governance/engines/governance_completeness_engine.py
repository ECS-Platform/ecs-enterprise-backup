...
from modules.operations.engines.operations_catalog import BANKING_APPLICATIONS, FRAMEWORK_CONTROLS, OWNERS, owner_for
...
def build_completeness_dashboard(
    ...
    from modules.governance.engines.missing_evidence_engine import compute_completeness_pct, compute_upload_kpis, get_all_missing_evidence
...
def build_completeness_dataset(role: str = "owner") -> dict:
    from modules.governance.engines.missing_evidence_engine import compute_upload_kpis, get_all_missing_evidence
