...
from modules.ai_sdlc.engines.ai_sdlc_document_artifacts import build_document_artifact
...
from modules.enterprise_grc.engines.ecs_demo_remediation import (
    build_ai_analytics_trends,
    build_registry_audit_trail,
    build_stage_card_drill,
    enrich_framework_drill,
)
from modules.ai_sdlc.engines.ecs_ai_governance_drilldowns import (
...
from modules.ai_sdlc.engines.ecs_sdlc_stage_dashboard import STAGE_KEY_TO_SLUG, build_stage_dashboard, resolve_stage_key, sdlc_stage_path
from modules.enterprise_grc.engines.ecs_governance_drilldowns import (
...
from modules.enterprise_grc.engines.ecs_governance_framework import (
    METRIC_TAB_MAP,
    build_control_360,
