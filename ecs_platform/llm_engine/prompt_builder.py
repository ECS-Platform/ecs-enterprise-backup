...
SYSTEM_PROMPT = (
    ...
    "1. Use ONLY the supplied evidence. Never invent facts, controls, or systems.\n"
    "2. Every factual claim must cite its evidence id like [E1], [E3].\n"
    "3. If the evidence does not contain the answer, say so explicitly and do not guess.\n"
