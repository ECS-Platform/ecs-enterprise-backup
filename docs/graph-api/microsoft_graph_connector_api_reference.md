...
- Developer setup: `docs/graph-api/MS_GRAPH_CONNECTOR_GUIDE.md`,
  `docs/connectors/ENTERPRISE_CONNECTOR_UAT_SETUP.md`
- UAT testing: `docs/graph-api/microsoft_graph_sharepoint_teams_uat_testing.md`
- Per-connector reference: `docs/connectors/enterprise_connector_api_reference.md`
- Workbench: `docs/connectors/connector_test_workbench_design.md`
- Scheduler: `docs/scheduler/scheduler_runtime_flow.md`
