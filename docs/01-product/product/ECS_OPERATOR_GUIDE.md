...
**Audience:** operations owners, platform/IT-ops engineers running ECS day-to-day. **Goal:** run, monitor, collect evidence, and troubleshoot. Grounded in `app/routes_platform.py`, `ecs_platform/ingestion.py`, `scripts/`, `docs/03-development/operations/ecs_runbook.md`.
...
| Reset DB | per `docs/03-development/operations/RECOVERY_RUNBOOK.md` |
...
Full table: `docs/01-product/00-start-here/TROUBLESHOOTING_GUIDE.md` and `docs/03-development/operations/ecs_runbook.md`.
...
- Demo broken → run validator, check `/healthz`, review `docs/05-archive/archive/ECS_DEMO_READINESS_REPORT.md` checklist.
