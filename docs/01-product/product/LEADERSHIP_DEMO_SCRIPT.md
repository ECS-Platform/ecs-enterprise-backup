...
operator steps live in [DEMO_RUNBOOK.md](../../03-development/operations/DEMO_RUNBOOK.md).
...
- "We have a **Bank Developer UAT Checklist** (VPN, DNS, ports, read-only service
  ...
  [UAT_INTEGRATION_GUIDE.md](../../03-development/developer-manual/connectors/UAT_INTEGRATION_GUIDE.md)."
- "What's left for production is **operational, not architectural** — durable
  ...
  [PRODUCTION_READINESS_GAP_REGISTER.md](../../03-development/production/PRODUCTION_READINESS_GAP_REGISTER.md).
