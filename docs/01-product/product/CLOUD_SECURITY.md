...
Prisma Cloud finding exports, IAM reviews, encryption configs, image scan reports. See [Prisma Cloud Integration](../../03-development/developer-manual/connectors/PRISMA_CLOUD.md).
