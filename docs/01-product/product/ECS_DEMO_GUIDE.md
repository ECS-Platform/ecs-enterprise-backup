...
Use `docs/01-product/product/ECS_KPI_REFERENCE.md` for any KPI a prospect asks about (definition + business meaning + good/warning/critical bands).
...
- Check `/healthz`. See `docs/05-archive/archive/ECS_DEMO_READINESS_REPORT.md` for the full checklist.
