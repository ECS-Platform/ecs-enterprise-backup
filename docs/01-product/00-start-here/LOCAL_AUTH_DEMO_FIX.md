...
| `docs/01-product/00-start-here/LOCAL_AUTH_DEMO_FIX.md` | This document. |
...
- **Benchmark files untouched:** `scripts/run_neev_validation_benchmark.py`, `scripts/run_16k_1k_token_validation.py`, `benchmarks/ai_workload/*`, `docs/04-testing/benchmarks/*` — not modified.
