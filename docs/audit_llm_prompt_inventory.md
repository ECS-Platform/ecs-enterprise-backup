...
> See [audit_llm_prompt_workbench_design.md](audit_llm_prompt_workbench_design.md)
> for the deterministic-vs-LLM policy and
> [audit_llm_16gb_20gb_testing_guide.md](audit_llm_16gb_20gb_testing_guide.md) for
