...
| Read-only Graph scopes | Documented in `docs/03-development/developer-manual/connectors/MS_GRAPH_CONNECTOR_GUIDE.md` |
...
| Connector docs | `docs/03-development/developer-manual/connectors/MS_GRAPH_CONNECTOR_GUIDE.md`, `docs/03-development/developer-manual/connectors/SHAREPOINT.md` |
