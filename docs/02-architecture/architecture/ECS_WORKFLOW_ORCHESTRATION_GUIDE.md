...
[Predefined Query Execution Workflow](../../03-development/operations/ECS_PREDEFINED_QUERY_EXECUTION_WORKFLOW.md) ·
[Predefined Query Execution Guide](../../03-development/operations/ECS_PREDEFINED_QUERY_EXECUTION_GUIDE.md) ·
[Control & Evidence Reuse](../../03-development/evidence-management/ECS_CONTROL_AND_EVIDENCE_REUSE_GUIDE.md) ·
[Framework Reference](../../01-product/product/ECS_FRAMEWORK_REFERENCE.md)
...
```
See [Control & Evidence Reuse Guide](../../03-development/evidence-management/ECS_CONTROL_AND_EVIDENCE_REUSE_GUIDE.md).
...
```
Full detail: [Predefined Query Execution Workflow](../../03-development/operations/ECS_PREDEFINED_QUERY_EXECUTION_WORKFLOW.md).
