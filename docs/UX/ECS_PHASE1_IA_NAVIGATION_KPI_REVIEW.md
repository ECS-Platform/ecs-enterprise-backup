...
- KPIs: [KPI Validation Report](../UAT/ECS_KPI_VALIDATION_REPORT.md), [Master KPI Dictionary](../PRODUCT/ECS_MASTER_KPI_DICTIONARY.md).
...
### 4.1 Principle
Every KPI must answer *"what decision does this enable?"* Target: **≤4 primary KPI cards + ≤1 secondary row** per page; **≥70% reduction** in visible KPI density. (Current dashboards present large KPI walls — see [KPI Validation Report](../UAT/ECS_KPI_VALIDATION_REPORT.md) for the full inventory.)
...
## Cross-references
- [Screen Validation Report](../UAT/ECS_SCREEN_VALIDATION_REPORT.md) · [Navigation Audit](../AUDIT/ECS_NAVIGATION_AUDIT.md) · [KPI Validation Report](../UAT/ECS_KPI_VALIDATION_REPORT.md) · [Master Product Manual](../PRODUCT/ECS_MASTER_PRODUCT_MANUAL.md) · [Master Use Case Registry](../PRODUCT/ECS_MASTER_USE_CASE_REGISTRY.md)
