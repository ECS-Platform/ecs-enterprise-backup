...
**Audit date:** 2026-06-17. Every route inventoried with **Route · Page Name · Module · Persona Access · Purpose · Dependencies · Documentation (Y/N) · Screenshot (Y/N)**. "Documentation" = covered in `docs/product/PRODUCT_MANUAL_ECS_SCREEN_CATALOG.md`. "Screenshot" = file present under `docs/product/screenshots/`. Persona access reflects intended RBAC (all personas in demo mode).
