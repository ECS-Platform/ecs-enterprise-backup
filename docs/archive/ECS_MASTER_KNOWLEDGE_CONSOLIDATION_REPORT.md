...
**Program:** ECS Master Use Case Reconciliation, AI, Integration & Knowledge Consolidation. **Inputs:** Phase 0 discovery (181 docs), [Document Reconciliation Report](ECS_DOCUMENT_RECONCILIATION_REPORT.md), [Master Use Case Registry](../product/ECS_MASTER_USE_CASE_REGISTRY.md), [Master Use Case & LLM Reference](../ai-sdlc/ECS_MASTER_USE_CASE_AND_LLM_REFERENCE.md), [LLM Implementation Matrix](../ai-sdlc/ECS_LLM_IMPLEMENTATION_MATRIX.md), [Master Integration Matrix](../connectors/ECS_MASTER_INTEGRATION_MATRIX.md).
...
| Class | SoT |
|---|---|
| Use cases (index) | [Master Use Case Registry](../product/ECS_MASTER_USE_CASE_REGISTRY.md) |
| Use cases (all-domain) | [Master Use Case Catalog](../product/ECS_MASTER_USE_CASE_CATALOG.md) |
| Use cases (AI/integration) | [Master Use Case & LLM Reference](../ai-sdlc/ECS_MASTER_USE_CASE_AND_LLM_REFERENCE.md) |
| KPIs | [Master KPI Dictionary](../product/ECS_MASTER_KPI_DICTIONARY.md) |
| Product | [Master Product Manual](../product/ECS_MASTER_PRODUCT_MANUAL.md) |
| AI/LLM | [AI Architecture Reference](../ai-sdlc/ECS_AI_ARCHITECTURE_REFERENCE.md), [LLM Implementation Matrix](../ai-sdlc/ECS_LLM_IMPLEMENTATION_MATRIX.md) |
| Integration | [Master Integration Matrix](../connectors/ECS_MASTER_INTEGRATION_MATRIX.md) |
| Frameworks | [Frameworks index](../product/_legacy_FRAMEWORKS_index.md) |
| Reconciliation | [Document Reconciliation Report](ECS_DOCUMENT_RECONCILIATION_REPORT.md) |

## Cross-references
- [Document Reconciliation](ECS_DOCUMENT_RECONCILIATION_REPORT.md) · [Use Case Registry](../product/ECS_MASTER_USE_CASE_REGISTRY.md) · [AI Master Reference](../ai-sdlc/ECS_MASTER_USE_CASE_AND_LLM_REFERENCE.md) · [LLM Roadmap](../ai-sdlc/ECS_LLM_IMPLEMENTATION_ROADMAP.md) · [Integration Matrix](../connectors/ECS_MASTER_INTEGRATION_MATRIX.md) · [docs index](../README.md)
