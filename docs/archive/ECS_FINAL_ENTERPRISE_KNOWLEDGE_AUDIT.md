...
| Framework | [Frameworks library](../product/_legacy_FRAMEWORKS_index.md) (15 docs) | **95%** | 11 catalog + 4 target frameworks marked inferred |
...
| Evidence | [Evidence Guide](../evidence-management/ECS_EVIDENCE_REFERENCE_GUIDE.md) | **95%** | archival/retention enforcement = target |
| Control | [Control Guide](../product/ECS_CONTROL_REFERENCE_GUIDE.md) | **96%** | compensating-control register = target |
| AI | 31 [docs/AI](../ai-sdlc/_legacy_AI_index.md) docs + lifecycle reference | **98%** | most mature domain |
| Security | [Security Reference](../production/ECS_SECURITY_REFERENCE.md) + AI security | **94%** | at-rest encryption = infra responsibility |
...
| Deployment | [Deployment Reference](../production/ECS_DEPLOYMENT_REFERENCE.md) | **93%** | SIT inferred; promotion/rollback documented |
| Integration | [Integrations](../connectors/_legacy_INTEGRATIONS_index.md) (9 guides + index) | **96%** | all interface-complete; UAT/PROD config documented |
...
- Evidence/Controls: [Evidence Guide](../evidence-management/ECS_EVIDENCE_REFERENCE_GUIDE.md), [Control Guide](../product/ECS_CONTROL_REFERENCE_GUIDE.md)
...
- Integrations: [Integrations index](../connectors/_legacy_INTEGRATIONS_index.md)
- Architecture/Security/Deployment/Testing: [Data](../architecture/ECS_DATA_ARCHITECTURE_REFERENCE.md), [Security](../production/ECS_SECURITY_REFERENCE.md), [Deployment](../production/ECS_DEPLOYMENT_REFERENCE.md), [Load Testing](../testing/ECS_LOAD_TESTING_REFERENCE.md)
- AI: [AI index](../ai-sdlc/_legacy_AI_index.md), [AI Lifecycle Reference](../ai-sdlc/ECS_AI_LIFECYCLE_REFERENCE.md)
