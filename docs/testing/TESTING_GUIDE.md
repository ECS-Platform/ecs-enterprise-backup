...
| RBAC | `pytest tests/test_authz_phase2.py tests/test_rbac_enforcement_phase2_step2b.py -q` | [`../architecture/ECS_ROLE_ACTION_MATRIX.md`](../architecture/ECS_ROLE_ACTION_MATRIX.md) |
...
## Load / performance
- [`ECS_LOAD_TESTING_REFERENCE.md`](ECS_LOAD_TESTING_REFERENCE.md) · benchmarks in [`../benchmarks/`](../benchmarks/README.md).
