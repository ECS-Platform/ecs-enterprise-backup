...
|---|---|---|
| **Local LLM** | Ollama `qwen3:8b` via `host.docker.internal`, keyless, `keep_alive` | [Architecture Reference](ECS_AI_ARCHITECTURE_REFERENCE.md), [Deployment](../production/ECS_LOCAL_LLM_DEPLOYMENT_GUIDE.md) |
...
| **Governance** | use-case lifecycle, model/prompt approval, posture (6 dims), revalidation, retirement | [Governance Operating Model](ECS_AI_GOVERNANCE_OPERATING_MODEL.md), [AI Governance framework](../../01-product/product/AI_GOVERNANCE.md) |
| **Testing** | grounding/citation/refusal tests, validation matrices | [Testing Guide](../../04-testing/benchmarks/ECS_LOCAL_LLM_TESTING_GUIDE.md), [Universal Validation Matrix](ECS_LOCAL_LLM_UNIVERSAL_VALIDATION_MATRIX.md) |
| **Monitoring** | connectivity (`llm_connectivity()`), `rag_status()`, perf benchmarks, hallucination rate | [Operations Guide](../operations/AI_ECS_LOCAL_LLM_OPERATIONS_GUIDE.md), [Performance Benchmark](../../04-testing/benchmarks/ECS_AI_PERFORMANCE_BENCHMARK.md), [Production Monitoring](../operations/ECS_PRODUCTION_MONITORING_GUIDE.md) |

## Phase-14 coverage statement
All Phase-14 topics are **covered by existing `docs/AI/` documents** (see [AI README index](_legacy_AI_index.md) and [Completeness Report](ECS_AI_DOCUMENT_COMPLETENESS_REPORT.md)). This reference adds the unifying lifecycle thread and cross-navigation; no new AI capability is implied. Inferred/Phase-2 items (e.g., automated AI scheduler for reindex, scaled cloud fallback) are flagged in the respective docs.

## Cross-references
- AI index: [docs/03-development/ai-sdlc/_legacy_AI_index.md](_legacy_AI_index.md)
- AI Governance framework: [../FRAMEWORKS/AI_GOVERNANCE.md](../../01-product/product/AI_GOVERNANCE.md)
