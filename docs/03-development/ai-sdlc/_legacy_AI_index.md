...
| 10 | [ECS_AI_PERFORMANCE_BENCHMARK.md](../../04-testing/benchmarks/ECS_AI_PERFORMANCE_BENCHMARK.md) | Reproducible harness + reference ranges |
...
> Related indexes: [Use Case Registry](../../01-product/product/ECS_MASTER_USE_CASE_REGISTRY.md) · [Integration Matrix](../connectors/ECS_MASTER_INTEGRATION_MATRIX.md) · [Document Reconciliation](../../05-archive/archive/ECS_DOCUMENT_RECONCILIATION_REPORT.md) · [Knowledge Consolidation](../../05-archive/archive/ECS_MASTER_KNOWLEDGE_CONSOLIDATION_REPORT.md)
...
| 2 | [ECS_LOCAL_LLM_DEPLOYMENT_GUIDE.md](../production/ECS_LOCAL_LLM_DEPLOYMENT_GUIDE.md) | Mac/Windows/Linux/UAT/Prod install, model pulls, pgvector, validation, troubleshooting |
...
| 6 | [ECS_LOCAL_LLM_TESTING_GUIDE.md](../../04-testing/benchmarks/ECS_LOCAL_LLM_TESTING_GUIDE.md) | Functional/Perf/Security/Accuracy/Hallucination/RAG/Vector tests |
| — | [ECS_LOCAL_LLM_OPERATIONS_GUIDE.md](../operations/AI_ECS_LOCAL_LLM_OPERATIONS_GUIDE.md) | Day-2 ops, health, change mgmt, failure modes, air-gap checklist |
