...
| AI-P3-02 | LLM performance is host/GPU bound (Ollama single model) | **P3** | Capacity guidance in [Load Testing Reference](../../04-testing/testing/ECS_LOAD_TESTING_REFERENCE.md). |
