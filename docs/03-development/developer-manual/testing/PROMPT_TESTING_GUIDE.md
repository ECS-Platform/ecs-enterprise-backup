...
[`docs/03-development/ai-sdlc/ECS_LOCAL_LLM_DEVELOPER_GUIDE.md`](../ai-sdlc/ECS_LOCAL_LLM_DEVELOPER_GUIDE.md).
For the RAM-profile benchmark plan see
[`docs/04-testing/benchmarks/audit_llm_16gb_20gb_testing_guide.md`](../../../04-testing/benchmarks/audit_llm_16gb_20gb_testing_guide.md).
...
- Prompt inventory (reference): `docs/03-development/audit-intelligence/audit_llm_prompt_inventory.md`
...
- Local LLM Developer Guide: `docs/03-development/ai-sdlc/ECS_LOCAL_LLM_DEVELOPER_GUIDE.md`
- Prompt workbench design: `docs/03-development/workbenches/audit_llm_prompt_workbench_design.md`
- 16 GB / 20 GB benchmark plan: `docs/04-testing/benchmarks/audit_llm_16gb_20gb_testing_guide.md`
- Prompt inventory: `docs/03-development/audit-intelligence/audit_llm_prompt_inventory.md`
- Connector Test Workbench (separate, connector-side): `docs/03-development/developer-manual/connectors/connector_test_workbench_design.md`
