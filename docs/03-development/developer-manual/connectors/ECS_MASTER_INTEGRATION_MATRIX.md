...
## Cross-references
- [Integrations index](_legacy_INTEGRATIONS_index.md) · [Master Use Case Registry](../../../01-product/product/ECS_MASTER_USE_CASE_REGISTRY.md) · [Master Use Case & LLM Reference](../ai-sdlc/ECS_MASTER_USE_CASE_AND_LLM_REFERENCE.md) · [Predefined Query Architecture](../operations/ECS_PREDEFINED_QUERY_ARCHITECTURE.md) · [Connector Activation Plan](../../../01-product/use-cases/ECS_CONNECTOR_ACTIVATION_PLAN.md) · [Remote Connector Expansion](../production/ECS_REMOTE_CONNECTOR_EXPANSION_PLAN.md)
