...
> See [`DOCUMENTATION_GAP_ANALYSIS.md`](../../05-archive/archive/DOCUMENTATION_GAP_ANALYSIS.md) for the audit behind it.
...
**Authoritative child:** [`docs/03-development/developer-manual/DEVELOPER_SETUP_GUIDE.md`](DEVELOPER_SETUP_GUIDE.md) — full
...
| Audience | Path |
|---|---|
| Engineers | [LLD](../../02-architecture/architecture/ecs_lld.md) → [ER diagrams](../../02-architecture/diagrams/ecs_er_diagrams.md) → [Sequences](../../02-architecture/diagrams/ecs_sequence_diagrams.md) |
| Architects | [EA review](../../02-architecture/architecture/ecs_enterprise_architecture_review.md) → [HLD](../../02-architecture/architecture/ecs_hld.md) → [Deployment](../../02-architecture/architecture/ecs_deployment_architecture.md) |
| Ops / SRE | [Operations runbook](../operations/ecs_runbook.md) → [Deployment](../../02-architecture/architecture/ecs_deployment_architecture.md) |
| Executives | [Technology dossier](../../05-archive/archive/ecs_technology_dossier.md) → [EA review](../../02-architecture/architecture/ecs_enterprise_architecture_review.md) |
...
**Authoritative child:** [`docs/03-development/developer-manual/LOCAL_DEVELOPMENT_GUIDE.md`](LOCAL_DEVELOPMENT_GUIDE.md).
...
**Authoritative child:** [`docs/03-development/operations/RECOVERY_RUNBOOK.md`](../operations/RECOVERY_RUNBOOK.md) — full backup, restore,
...
**Authoritative child:** [`docs/03-development/developer-manual/ECS_MODULE_OWNERSHIP.md`](ECS_MODULE_OWNERSHIP.md) — owner matrix,
...
| Setup (per-OS + Docker) | [`docs/03-development/developer-manual/DEVELOPER_SETUP_GUIDE.md`](DEVELOPER_SETUP_GUIDE.md) |
| Developer workflow | [`docs/03-development/developer-manual/LOCAL_DEVELOPMENT_GUIDE.md`](LOCAL_DEVELOPMENT_GUIDE.md) |
...
| Backup / restore / migration | [`docs/03-development/operations/RECOVERY_RUNBOOK.md`](../operations/RECOVERY_RUNBOOK.md) |
| Module ownership & branching | [`docs/03-development/developer-manual/ECS_MODULE_OWNERSHIP.md`](ECS_MODULE_OWNERSHIP.md) |
| Cross-module coupling | [`docs/03-development/developer-manual/ECS_DEPENDENCY_REPORT.md`](ECS_DEPENDENCY_REPORT.md) |
| Gap analysis behind this handbook | [`docs/05-archive/archive/DOCUMENTATION_GAP_ANALYSIS.md`](../../05-archive/archive/DOCUMENTATION_GAP_ANALYSIS.md) |

**Superseded / use with caution**

| Document | Status |
|---|---|
| `docs/01-product/00-start-here/ECS_DEMO_MODE_SETUP_AND_TROUBLESHOOTING.md` | **Superseded by §4–§5/§12.** Its ".env not loaded" claim is incorrect for the current build. |
| `docs/02-architecture/architecture/ECS_Architecture_and_Deployment_Guide.md` §13/§15–§17 | **Superseded** for setup/deps/env (states 4 deps, "no Docker", "no .env"). Its as-built-vs-target comparison remains useful. |
| Root `architecture/ecs_enterprise_architecture_review.md` | Duplicate of `docs/02-architecture/architecture/...`; use the `docs/` copy. |
