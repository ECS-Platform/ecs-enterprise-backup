...
[LEADERSHIP_DEMO_SCRIPT.md](../../01-product/product/LEADERSHIP_DEMO_SCRIPT.md) and the executive
[Technology Dossier](../../05-archive/archive/ecs_technology_dossier.md).
...
Deep dives: [Enterprise Architecture Review](../../02-architecture/architecture/ecs_enterprise_architecture_review.md),
[HLD](../../02-architecture/architecture/ecs_hld.md), [LLD](../../02-architecture/architecture/ecs_lld.md),
[Deployment Architecture](../../02-architecture/architecture/ecs_deployment_architecture.md),
[ER diagrams](../../02-architecture/diagrams/ecs_er_diagrams.md),
[Sequence diagrams](../../02-architecture/diagrams/ecs_sequence_diagrams.md).
...
the [Data Architecture Reference](../../02-architecture/architecture/ECS_DATA_ARCHITECTURE_REFERENCE.md)
...
| `frameworks` | Framework catalog | [../FRAMEWORKS/README.md](../../01-product/product/_legacy_FRAMEWORKS_index.md) |
| `governance` | Governance workflows | [../WORKFLOWS/README.md](../../02-architecture/architecture/_legacy_WORKFLOWS_index.md) |
...
- UI-to-API flows: [LLD §8](../../02-architecture/architecture/ecs_lld.md).
...
and [Data Architecture Reference](../../02-architecture/architecture/ECS_DATA_ARCHITECTURE_REFERENCE.md).
...
[E2E_SMOKE_TEST_GUIDE](../../04-testing/testing/E2E_SMOKE_TEST_GUIDE.md).
...
> Cross-refs: [../TROUBLESHOOTING_GUIDE.md](../../01-product/00-start-here/TROUBLESHOOTING_GUIDE.md),
> [../operations/CONNECTOR_TROUBLESHOOTING_RUNBOOK.md](../operations/CONNECTOR_TROUBLESHOOTING_RUNBOOK.md),
> [../ECS_DEMO_MODE_SETUP_AND_TROUBLESHOOTING.md](../../01-product/00-start-here/ECS_DEMO_MODE_SETUP_AND_TROUBLESHOOTING.md).
...
|------|-----------------|
| Enterprise Architecture | [architecture/ecs_enterprise_architecture_review.md](../../02-architecture/architecture/ecs_enterprise_architecture_review.md), [hld/ecs_hld.md](../../02-architecture/architecture/ecs_hld.md), [lld/ecs_lld.md](../../02-architecture/architecture/ecs_lld.md) |
