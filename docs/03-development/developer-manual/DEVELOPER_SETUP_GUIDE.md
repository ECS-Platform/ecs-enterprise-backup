...
Everything else can stay at its `.env.example` default. See `docs/03-development/developer-manual/ENVIRONMENT_CONFIGURATION.md` for the full table.
...
Stuck? See `docs/01-product/00-start-here/TROUBLESHOOTING_GUIDE.md`.
