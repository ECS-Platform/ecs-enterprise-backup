...
## Run ECS locally
- Quickstart / demo mode: [`../00-start-here/DEMO_MODE_SETUP.md`](../../01-product/00-start-here/DEMO_MODE_SETUP.md), [`../00-start-here/COMMON_COMMANDS.md`](../../01-product/00-start-here/COMMON_COMMANDS.md)
...
## Run tests
- Full test map: [`../testing/TESTING_GUIDE.md`](../../04-testing/testing/TESTING_GUIDE.md)
- Smoke: [`../testing/E2E_SMOKE_TEST_GUIDE.md`](../../04-testing/testing/E2E_SMOKE_TEST_GUIDE.md)
...
- Architecture: [`../architecture/ARCHITECTURE_INDEX.md`](../../02-architecture/architecture/ARCHITECTURE_INDEX.md)
