...
- **[`../use-cases/PREDEFINED_QUERY_INVENTORY.md`](../../../01-product/use-cases/PREDEFINED_QUERY_INVENTORY.md)** —
...
## Coverage & execution
- Framework/technology coverage: [`../use-cases/PREDEFINED_QUERY_FRAMEWORK_COVERAGE_MATRIX.md`](../../../01-product/use-cases/PREDEFINED_QUERY_FRAMEWORK_COVERAGE_MATRIX.md)
...
- Testing: [`../testing/PREDEFINED_QUERY_TESTING_GUIDE.md`](../../../04-testing/testing/PREDEFINED_QUERY_TESTING_GUIDE.md).
