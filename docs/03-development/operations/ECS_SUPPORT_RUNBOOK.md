...
**Audience:** L1/L2 support. **Goal:** triage and resolve incidents by symptom. Grounded in `app/routes_platform.py`, `app/auth/*`, `config/*.yaml`, `docker-compose.yml`, and existing `docs/01-product/00-start-here/TROUBLESHOOTING_GUIDE.md` / `docs/03-development/operations/ecs_runbook.md`. Documentation only.
...
| 14 | Count mismatch in UI vs docs | catalog vs demo-seed | expected; see `docs/05-archive/archive/ECS_DOCUMENTATION_INVENTORY.md §5` | n/a |
