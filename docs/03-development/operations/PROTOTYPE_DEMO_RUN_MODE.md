...
- `docs/01-product/00-start-here/DEMO_MODE_SETUP.md` — demo quickstart
- `docs/03-development/operations/environment-configuration/00_ENVIRONMENT_CONFIGURATION_GUIDE.md` — full env framework
- `docs/03-development/operations/UAT_VALIDATION_RUNBOOK.md` — UAT validation
