...
| Source connector enable + validation | P1 | [Connector Activation Plan](../../01-product/use-cases/ECS_CONNECTOR_ACTIVATION_PLAN.md) |
| Per-env target lists | P1 | [Predefined Query Plan](../../01-product/use-cases/ECS_PREDEFINED_QUERY_IMPLEMENTATION_PLAN.md) |
| RAF first-class entity | P2 | [RAF Plan](../../01-product/use-cases/ECS_RAF_IMPLEMENTATION_PLAN.md) |
...
## Cross-references
- [Final Production Roadmap](../production/ECS_FINAL_PRODUCTION_ROADMAP.md) · [Phase 1 Execution Roadmap](../../01-product/use-cases/ECS_PHASE1_EXECUTION_ROADMAP.md) · [Go-Live Readiness](../../05-archive/archive/ECS_PHASE1_GO_LIVE_READINESS_REPORT.md)
