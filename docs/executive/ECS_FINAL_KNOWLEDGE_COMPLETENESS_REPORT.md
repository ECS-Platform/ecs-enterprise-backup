...
| `docs/FRAMEWORKS/ECS_FRAMEWORK_REFERENCE.md` | All 15 catalog frameworks (+ inferred MBSS/Middleware): purpose, controls, checklists, mappings, evidence, reuse, audit/exec relevance |
...
| Document | Covers |
|----------|--------|
| `docs/ENVIRONMENT_CONFIGURATION_FRAMEWORK.md` | YAML environment framework, loader, migration/UAT/PROD/deploy guides |
| `docs/ENVIRONMENT_FRAMEWORK_READINESS_REPORT.md` | Per-module readiness, score 88/100, UAT/PROD gaps |
| `docs/ECS_CONFIGURATION_DEPENDENCY_MATRIX.md` | Module/connector/db/app/framework → YAML mapping |
| `docs/ECS_HARDCODED_DEPENDENCY_INVENTORY.md` | Phase-1 hardcoded scan (0 public IPs in app code) |
| `docs/ECS_PERSONA_CONFIGURATION_MATRIX.md` | 21 personas × config load |
| `docs/ECS_APPLICATION_CONFIGURATION_MATRIX.md` | 15 apps × env |
| `docs/ECS_ENVIRONMENT_VALIDATION_MATRIX.md` | Module/persona/app × 5 envs validation |
...
- The residual ~7% is concentrated in **Testing** (load test + 2 pre-existing
  ...
  items already captured in `docs/PHASE1/ECS_PHASE1_IMPLEMENTATION_BACKLOG.md`,
...
- **Environment:** `docs/ENVIRONMENT_CONFIGURATION_FRAMEWORK.md`, `…/ENVIRONMENT_FRAMEWORK_READINESS_REPORT.md`, `docs/ECS_CONFIGURATION_DEPENDENCY_MATRIX.md`, `…/ECS_ENVIRONMENT_VALIDATION_MATRIX.md`, `…/ECS_HARDCODED_DEPENDENCY_INVENTORY.md`, `…/ECS_PERSONA_CONFIGURATION_MATRIX.md`, `…/ECS_APPLICATION_CONFIGURATION_MATRIX.md`
- **Operations:** `docs/OPERATIONS/ECS_PREDEFINED_QUERY_EXECUTION_GUIDE.md`, `…/ECS_CONTROL_AND_EVIDENCE_REUSE_GUIDE.md`
- **Frameworks:** `docs/FRAMEWORKS/ECS_FRAMEWORK_REFERENCE.md`
