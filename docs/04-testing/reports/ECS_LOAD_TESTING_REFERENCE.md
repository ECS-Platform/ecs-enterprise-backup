...
- **AI:** offload heavy/long-context jobs to cloud provider (hybrid) per [LLM Decision Matrix](../../03-development/ai-sdlc/ECS_LOCAL_VS_CLOUD_LLM_DECISION_MATRIX.md).
- **Caching:** add KPI result caching (Redis) for large tenants — **[Phase 2 enhancement]**.

## Cross-references
- Deployment scaling: [ECS_DEPLOYMENT_REFERENCE.md](../../03-development/production/ECS_DEPLOYMENT_REFERENCE.md)
- AI operations: [ECS_LOCAL_LLM_OPERATIONS_GUIDE.md](../../03-development/operations/OPERATIONS_ECS_LOCAL_LLM_OPERATIONS_GUIDE.md)
- Data model/indexes: [ECS_DATA_ARCHITECTURE_REFERENCE.md](../../02-architecture/architecture/ECS_DATA_ARCHITECTURE_REFERENCE.md)
