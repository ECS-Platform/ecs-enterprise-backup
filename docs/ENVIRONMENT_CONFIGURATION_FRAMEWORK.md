...
See also: `docs/ECS_CONFIGURATION_DEPENDENCY_MATRIX.md`,
`docs/ECS_PERSONA_CONFIGURATION_MATRIX.md`,
`docs/ECS_APPLICATION_CONFIGURATION_MATRIX.md`,
`docs/ECS_ENVIRONMENT_VALIDATION_MATRIX.md`,
