...
**Audit date:** 2026-06-17. Every ECS feature/page with **Purpose · Persona · Inputs · Outputs · KPIs · Drilldowns · Reports · Data source · Business value**. Grounded in the route registrars and engines. For deep per-screen detail see `docs/product_manual/ECS_SCREEN_CATALOG.md`; for KPI formulas see `docs/product_manual/ECS_KPI_DICTIONARY.md`.
