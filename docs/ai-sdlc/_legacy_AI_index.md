...
| 10 | [ECS_AI_PERFORMANCE_BENCHMARK.md](../benchmarks/ECS_AI_PERFORMANCE_BENCHMARK.md) | Reproducible harness + reference ranges |
...
> Related indexes: [Use Case Registry](../product/ECS_MASTER_USE_CASE_REGISTRY.md) · [Integration Matrix](../connectors/ECS_MASTER_INTEGRATION_MATRIX.md) · [Document Reconciliation](../archive/ECS_DOCUMENT_RECONCILIATION_REPORT.md) · [Knowledge Consolidation](../archive/ECS_MASTER_KNOWLEDGE_CONSOLIDATION_REPORT.md)
...
| 6 | [ECS_LOCAL_LLM_TESTING_GUIDE.md](../benchmarks/ECS_LOCAL_LLM_TESTING_GUIDE.md) | Functional/Perf/Security/Accuracy/Hallucination/RAG/Vector tests |
