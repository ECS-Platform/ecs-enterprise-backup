...
> See [`DOCUMENTATION_GAP_ANALYSIS.md`](DOCUMENTATION_GAP_ANALYSIS.md) for the audit behind it.
...
**Authoritative child:** [`docs/DEVELOPER_SETUP_GUIDE.md`](DEVELOPER_SETUP_GUIDE.md) — full
...
| Audience | Path |
|---|---|
| Engineers | [LLD](lld/ecs_lld.md) → [ER diagrams](diagrams/ecs_er_diagrams.md) → [Sequences](diagrams/ecs_sequence_diagrams.md) |
| Architects | [EA review](architecture/ecs_enterprise_architecture_review.md) → [HLD](hld/ecs_hld.md) → [Deployment](architecture/ecs_deployment_architecture.md) |
| Ops / SRE | [Operations runbook](operations/ecs_runbook.md) → [Deployment](architecture/ecs_deployment_architecture.md) |
| Executives | [Technology dossier](executive/ecs_technology_dossier.md) → [EA review](architecture/ecs_enterprise_architecture_review.md) |
...
**Authoritative child:** [`docs/LOCAL_DEVELOPMENT_GUIDE.md`](LOCAL_DEVELOPMENT_GUIDE.md).
...
> planned path — see [`RECOVERY_RUNBOOK.md`](RECOVERY_RUNBOOK.md) §5.
...
**Authoritative child:** [`docs/RECOVERY_RUNBOOK.md`](RECOVERY_RUNBOOK.md) — full backup, restore,
...
**Authoritative child:** [`docs/ECS_MODULE_OWNERSHIP.md`](ECS_MODULE_OWNERSHIP.md) — owner matrix,
...
| Setup (per-OS + Docker) | [`docs/DEVELOPER_SETUP_GUIDE.md`](DEVELOPER_SETUP_GUIDE.md) |
| Developer workflow | [`docs/LOCAL_DEVELOPMENT_GUIDE.md`](LOCAL_DEVELOPMENT_GUIDE.md) |
...
| Backup / restore / migration | [`docs/RECOVERY_RUNBOOK.md`](RECOVERY_RUNBOOK.md) |
| Module ownership & branching | [`docs/ECS_MODULE_OWNERSHIP.md`](ECS_MODULE_OWNERSHIP.md) |
| Cross-module coupling | [`docs/ECS_DEPENDENCY_REPORT.md`](ECS_DEPENDENCY_REPORT.md) |
| Gap analysis behind this handbook | [`docs/DOCUMENTATION_GAP_ANALYSIS.md`](DOCUMENTATION_GAP_ANALYSIS.md) |

**Superseded / use with caution**

| Document | Status |
|---|---|
| `docs/ECS_DEMO_MODE_SETUP_AND_TROUBLESHOOTING.md` | **Superseded by §4–§5/§12.** Its ".env not loaded" claim is incorrect for the current build. |
| `docs/ECS_Architecture_and_Deployment_Guide.md` §13/§15–§17 | **Superseded** for setup/deps/env (states 4 deps, "no Docker", "no .env"). Its as-built-vs-target comparison remains useful. |
