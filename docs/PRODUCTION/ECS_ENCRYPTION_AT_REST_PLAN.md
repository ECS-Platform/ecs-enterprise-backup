...
## Cross-references
- [Production Master Plan](ECS_PRODUCTION_READINESS_MASTER_PLAN.md) · [SSO/OIDC Plan](ECS_SSO_OIDC_IMPLEMENTATION_PLAN.md) · [Security Reference](../SECURITY/ECS_SECURITY_REFERENCE.md) · [Backup & Recovery](../operations/ECS_BACKUP_AND_RECOVERY_GUIDE.md)
