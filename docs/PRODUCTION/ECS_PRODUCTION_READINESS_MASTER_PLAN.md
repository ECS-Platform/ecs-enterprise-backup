...
| Gap | Priority | Plan |
|---|---|---|
| SSO/OIDC configuration + role mapping | P1 | [SSO/OIDC Plan](ECS_SSO_OIDC_IMPLEMENTATION_PLAN.md) |
| Encryption at rest (DB/object/backups) + KMS | P1 | [Encryption Plan](ECS_ENCRYPTION_AT_REST_PLAN.md) |
| Observation durability enablement | P1 | [Durability Plan](ECS_OBSERVATION_DURABILITY_ENABLEMENT_PLAN.md) |
| Remote query connectors | P1/P2 | [Remote Connector Plan](ECS_REMOTE_CONNECTOR_EXPANSION_PLAN.md) |
| Source connector enable + validation | P1 | [Connector Activation Plan](../PHASE1/ECS_CONNECTOR_ACTIVATION_PLAN.md) |
| Per-env target lists | P1 | [Predefined Query Plan](../PHASE1/ECS_PREDEFINED_QUERY_IMPLEMENTATION_PLAN.md) |
| RAF first-class entity | P2 | [RAF Plan](../PHASE1/ECS_RAF_IMPLEMENTATION_PLAN.md) |
...
## Cross-references
- [Final Production Roadmap](ECS_FINAL_PRODUCTION_ROADMAP.md) · [Phase 1 Execution Roadmap](../PHASE1/ECS_PHASE1_EXECUTION_ROADMAP.md) · [Go-Live Readiness](../executive/ECS_PHASE1_GO_LIVE_READINESS_REPORT.md)
