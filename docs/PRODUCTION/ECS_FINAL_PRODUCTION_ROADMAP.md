...
| ID | Item | Effort | Plan |
|---|---|---:|---|
| P1-A | SSO/OIDC config + role mapping (Azure AD/Entra) | 3–6d | [SSO Plan](ECS_SSO_OIDC_IMPLEMENTATION_PLAN.md) |
| P1-B | Encryption at rest (DB/object/backups) + KMS | 4–6d | [Encryption Plan](ECS_ENCRYPTION_AT_REST_PLAN.md) |
| P1-C | Observation durability enablement + migration | 3d | [Durability Plan](ECS_OBSERVATION_DURABILITY_ENABLEMENT_PLAN.md) |
| P1-D | Source connector enable + per-tenant validation | 3–5d | [Activation Plan](../PHASE1/ECS_CONNECTOR_ACTIVATION_PLAN.md) |
| P1-E | Populate per-env target lists | 1–2d | [Predefined Query Plan](../PHASE1/ECS_PREDEFINED_QUERY_IMPLEMENTATION_PLAN.md) |
| P1-F | Demo-target query validation (PG/Linux/Sonar/Trivy/Gitleaks) | 3–5d | [Activation Plan](../PHASE1/ECS_CONNECTOR_ACTIVATION_PLAN.md) |

### P2 — Hardening / completeness
| ID | Item | Effort | Plan |
|---|---|---:|---|
| P2-A | Remote DB connectors (Oracle/MySQL/SQL Server) | 5–7d | [Remote Connector Plan](ECS_REMOTE_CONNECTOR_EXPANSION_PLAN.md) |
| P2-B | Generic SSH + Windows (WinRM) | 6–7d | [Remote Connector Plan](ECS_REMOTE_CONNECTOR_EXPANSION_PLAN.md) |
| P2-C | RAF first-class entity + ISG approval | ~14d | [RAF Plan](../PHASE1/ECS_RAF_IMPLEMENTATION_PLAN.md) |
...
## Cross-references
- [Production Master Plan](ECS_PRODUCTION_READINESS_MASTER_PLAN.md) · [SSO/OIDC](ECS_SSO_OIDC_IMPLEMENTATION_PLAN.md) · [Encryption](ECS_ENCRYPTION_AT_REST_PLAN.md) · [Durability](ECS_OBSERVATION_DURABILITY_ENABLEMENT_PLAN.md) · [Remote Connectors](ECS_REMOTE_CONNECTOR_EXPANSION_PLAN.md)
- [Phase 1 Execution Roadmap](../PHASE1/ECS_PHASE1_EXECUTION_ROADMAP.md) · [Go-Live Readiness](../executive/ECS_PHASE1_GO_LIVE_READINESS_REPORT.md)
