...
[LEADERSHIP_DEMO_SCRIPT.md](../product/LEADERSHIP_DEMO_SCRIPT.md) and the executive
[Technology Dossier](../archive/ecs_technology_dossier.md).
...
[HLD](../architecture/ecs_hld.md), [LLD](../architecture/ecs_lld.md),
...
- Environment promotion is **config-only**: the *same image* moves
  ...
  (see [Deployment Reference](../production/ECS_DEPLOYMENT_REFERENCE.md)).
...
- **API response shape:** success `{"ok": true, ...}`; error
  ...
  [PERFORMANCE_AND_HARDENING_GUIDE.md](../production/PERFORMANCE_AND_HARDENING_GUIDE.md)).
...
| `frameworks` | Framework catalog | [../FRAMEWORKS/README.md](../product/_legacy_FRAMEWORKS_index.md) |
| `governance` | Governance workflows | [../WORKFLOWS/README.md](../architecture/_legacy_WORKFLOWS_index.md) |
| `shared` | Cross-cutting state, utils (pagination, cache), routes, templates | [PERFORMANCE_AND_HARDENING_GUIDE](../production/PERFORMANCE_AND_HARDENING_GUIDE.md) |
...
[EVIDENCE_COLLECTION_GUIDE](../evidence-management/EVIDENCE_COLLECTION_GUIDE.md),
[EVIDENCE_VALIDATION_GUIDE](../evidence-management/EVIDENCE_VALIDATION_GUIDE.md),
[OBSERVATION_AND_REPOSITORY_GUIDE](../evidence-management/OBSERVATION_AND_REPOSITORY_GUIDE.md).
...
- Audit Intelligence API: `/api/audit/*` (dashboard, assets, mapping, runs,
  ...
  ([PERFORMANCE_AND_HARDENING_GUIDE](../production/PERFORMANCE_AND_HARDENING_GUIDE.md)).
...
- UI-to-API flows: [LLD §8](../architecture/ecs_lld.md).
...
[AUDIT_INTELLIGENCE_PERSISTENCE_GUIDE](../audit-intelligence/AUDIT_INTELLIGENCE_PERSISTENCE_GUIDE.md)
...
and the [Deployment Reference](../production/ECS_DEPLOYMENT_REFERENCE.md).
...
[E2E_SMOKE_TEST_GUIDE](../testing/E2E_SMOKE_TEST_GUIDE.md).
...
mapping projection. Guide: [EVIDENCE_COLLECTION_GUIDE](../evidence-management/EVIDENCE_COLLECTION_GUIDE.md),
[../operations/ECS_CONTROL_AND_EVIDENCE_REUSE_GUIDE.md](../evidence-management/ECS_CONTROL_AND_EVIDENCE_REUSE_GUIDE.md).
...
> Cross-refs: [../TROUBLESHOOTING_GUIDE.md](../00-start-here/TROUBLESHOOTING_GUIDE.md),
> [../operations/CONNECTOR_TROUBLESHOOTING_RUNBOOK.md](../operations/CONNECTOR_TROUBLESHOOTING_RUNBOOK.md),
> [../ECS_DEMO_MODE_SETUP_AND_TROUBLESHOOTING.md](../00-start-here/ECS_DEMO_MODE_SETUP_AND_TROUBLESHOOTING.md).
...
|------|-----------------|
| Enterprise Architecture | [architecture/ecs_enterprise_architecture_review.md](../architecture/ecs_enterprise_architecture_review.md), [hld/ecs_hld.md](../architecture/ecs_hld.md), [lld/ecs_lld.md](../architecture/ecs_lld.md) |
...
| Deployment | [../DEPLOYMENT/ECS_DEPLOYMENT_REFERENCE.md](../production/ECS_DEPLOYMENT_REFERENCE.md), [../architecture/ecs_deployment_architecture.md](../architecture/ecs_deployment_architecture.md), [../operations/DEPLOYMENT_RUNBOOK.md](../operations/DEPLOYMENT_RUNBOOK.md) |
| Administrator / Operations | [../TRAINING/ECS_ADMIN_GUIDE.md](../product/ECS_ADMIN_GUIDE.md), [../operations/ecs_runbook.md](../operations/ecs_runbook.md), [../operations/ECS_OPERATIONS_RUNBOOK.md](../operations/ECS_OPERATIONS_RUNBOOK.md) |
...
| Evidence / Controls / Frameworks | [EVIDENCE_COLLECTION_GUIDE.md](../evidence-management/EVIDENCE_COLLECTION_GUIDE.md), [../FRAMEWORKS/README.md](../product/_legacy_FRAMEWORKS_index.md) |
...
| API / Database | [../lld/ecs_lld.md](../architecture/ecs_lld.md) (UI-to-API flows), [../architecture/ECS_DATA_ARCHITECTURE_REFERENCE.md](../architecture/ECS_DATA_ARCHITECTURE_REFERENCE.md), [../DB_SCHEMA_AUDIT_INTELLIGENCE.sql](../DB_SCHEMA_AUDIT_INTELLIGENCE.sql) |
| Troubleshooting / Support | [../TROUBLESHOOTING_GUIDE.md](../00-start-here/TROUBLESHOOTING_GUIDE.md), [../operations/ECS_SUPPORT_RUNBOOK.md](../operations/ECS_SUPPORT_RUNBOOK.md) |
