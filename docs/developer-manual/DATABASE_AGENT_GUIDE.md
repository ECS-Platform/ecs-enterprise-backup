...
> jump-server model in [`../architecture/ENTERPRISE_ARCHITECTURE.md`](../architecture/ENTERPRISE_ARCHITECTURE.md) §4.
...
See the [Testing Guide](../testing/TESTING_GUIDE.md) for the full test map.
...
- [`../architecture/ENTERPRISE_ARCHITECTURE.md`](../architecture/ENTERPRISE_ARCHITECTURE.md) §4 — jump-server model
