...
> (per-connector UAT config), [E2E_SMOKE_TEST_GUIDE.md](../testing/E2E_SMOKE_TEST_GUIDE.md)
...
- **Local auth / demo mode:** `docs/00-start-here/LOCAL_AUTH_DEMO_FIX.md`, `docs/00-start-here/DEMO_MODE_SETUP.md`
- **Common commands:** `docs/00-start-here/COMMON_COMMANDS.md`
