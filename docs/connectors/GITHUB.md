...
**Grounding:** `config/integrations.yaml` (`github`), `ecs_platform/ingestion.py`. Part of [Integrations Index](_legacy_INTEGRATIONS_index.md). Interface-complete, `enabled: false` by default. (Mirrors the always-on Gitea connector's object model.)
