...
## Architecture
ECS connector → Prisma Cloud API (`${PRISMA_URL}`) → pulls CSPM findings → evidence → repository. Primary source for **Cloud Security** posture (see [Cloud Security framework](../product/CLOUD_SECURITY.md)).
