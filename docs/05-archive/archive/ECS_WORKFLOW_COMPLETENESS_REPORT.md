...
**Navigation:** [Workflows Index](../../02-architecture/architecture/_legacy_WORKFLOWS_index.md) ·
...
| 2 | [ECS_WORKFLOW_ORCHESTRATION_GUIDE.md](../../02-architecture/architecture/ECS_WORKFLOW_ORCHESTRATION_GUIDE.md) — 20 workflows + diagrams | ✅ Complete |
| 3 | [ECS_ROLE_ACTION_MATRIX.md](../../02-architecture/architecture/ECS_ROLE_ACTION_MATRIX.md) — 15 roles CRUD matrix | ✅ Complete |
| 4 | [ECS_STATE_TRANSITION_MATRIX.md](../../02-architecture/architecture/ECS_STATE_TRANSITION_MATRIX.md) | ✅ Complete |
| 5 | [ECS_SLA_ESCALATION_MATRIX.md](../../02-architecture/architecture/ECS_SLA_ESCALATION_MATRIX.md) | ✅ Complete |
| 6 | [ECS_NOTIFICATION_MATRIX.md](../../02-architecture/architecture/ECS_NOTIFICATION_MATRIX.md) | ✅ Complete |
| 7 | [ECS_BUSINESS_PROCESS_MODEL.md](../../02-architecture/architecture/ECS_BUSINESS_PROCESS_MODEL.md) | ✅ Complete |
| 8 | [ECS_PREDEFINED_QUERY_EXECUTION_WORKFLOW.md](../OPERATIONS/ECS_PREDEFINED_QUERY_EXECUTION_WORKFLOW.md) | ✅ Complete |
| 9 | [ECS_SEQUENCE_DIAGRAMS.md](../../02-architecture/architecture/ECS_SEQUENCE_DIAGRAMS.md) — 10 lifecycles | ✅ Complete |
...
[docs/02-architecture/architecture/_legacy_WORKFLOWS_index.md](../../02-architecture/architecture/_legacy_WORKFLOWS_index.md) (new package index). Navigation
