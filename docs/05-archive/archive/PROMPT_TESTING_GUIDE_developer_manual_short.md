...
> - LLM architecture: [`../ai-sdlc/ECS_AI_ARCHITECTURE_REFERENCE.md`](../../03-development/ai-sdlc/ECS_AI_ARCHITECTURE_REFERENCE.md)
> - Local LLM dev: [`../ai-sdlc/ECS_LOCAL_LLM_DEVELOPER_GUIDE.md`](../../03-development/ai-sdlc/ECS_LOCAL_LLM_DEVELOPER_GUIDE.md)
> - Prompt inventory (40 prompts): [`../audit-intelligence/audit_llm_prompt_inventory.md`](../../03-development/audit-intelligence/audit_llm_prompt_inventory.md)
> - Workbench design: [`../workbenches/audit_llm_prompt_workbench_design.md`](../../03-development/workbenches/audit_llm_prompt_workbench_design.md)
> - Benchmarks (16/20 GB): [`../benchmarks/audit_llm_16gb_20gb_testing_guide.md`](../../04-testing/benchmarks/audit_llm_16gb_20gb_testing_guide.md)
...
## Related
- [`../developer-manual/DEVELOPER_MANUAL.md`](DEVELOPER_MANUAL.md) · [`../testing/TESTING_GUIDE.md`](../../04-testing/testing/TESTING_GUIDE.md) · [`../runbooks/LLM_PROMPT_FAILURE_RUNBOOK.md`](../../03-development/runbooks/LLM_PROMPT_FAILURE_RUNBOOK.md)
