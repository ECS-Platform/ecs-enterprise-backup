...
**Audit date:** 2026-06-17. Every ECS feature/page with **Purpose · Persona · Inputs · Outputs · KPIs · Drilldowns · Reports · Data source · Business value**. Grounded in the route registrars and engines. For deep per-screen detail see `docs/01-product/product/PRODUCT_MANUAL_ECS_SCREEN_CATALOG.md`; for KPI formulas see `docs/01-product/product/PRODUCT_MANUAL_ECS_KPI_DICTIONARY.md`.
