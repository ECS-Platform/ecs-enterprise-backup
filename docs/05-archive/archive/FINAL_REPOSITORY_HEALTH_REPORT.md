...
- **240 Markdown documents** across 29 areas; indexed by
  ...
  [architecture/ARCHITECTURE_INDEX.md](../../02-architecture/architecture/ARCHITECTURE_INDEX.md).
- **API reference** ([API/ECS_API_REFERENCE.md](../../03-development/developer-manual/ECS_API_REFERENCE.md)) and
...
- **Docs:** [DEVELOPER/UAT_ASSET_DRIVEN_SCHEDULER_DESIGN.md](../../03-development/developer-manual/phase1/scheduler/UAT_ASSET_DRIVEN_SCHEDULER_DESIGN.md),
  [operations/ECS_SCHEDULER_REFERENCE.md](../../03-development/operations/ECS_SCHEDULER_REFERENCE.md).
...
- **CLI:** `scripts/run_predefined_query.py --control <ID>` /
  `--list [--technology <T>]`.
- **Docs:** [DEVELOPER/PREDEFINED_DATABASE_QUERY_MODULE.md](../../03-development/developer-manual/PREDEFINED_DATABASE_QUERY_MODULE.md),
  [operations/ECS_PREDEFINED_QUERY_EXECUTION_GUIDE.md](../../03-development/operations/ECS_PREDEFINED_QUERY_EXECUTION_GUIDE.md),
  [DEVELOPER/AEROSPIKE_LOCAL_TESTING_GUIDE.md](../../03-development/developer-manual/connectors/AEROSPIKE_LOCAL_TESTING_GUIDE.md).
...
Tracked in [DEVELOPER/PRODUCTION_READINESS_GAP_REGISTER.md](../../03-development/production/PRODUCTION_READINESS_GAP_REGISTER.md).
