...
> full inventory in [../use-cases/PREDEFINED_QUERY_INVENTORY.md](../../01-product/use-cases/PREDEFINED_QUERY_INVENTORY.md),
> coverage in [../use-cases/PREDEFINED_QUERY_FRAMEWORK_COVERAGE_MATRIX.md](../../01-product/use-cases/PREDEFINED_QUERY_FRAMEWORK_COVERAGE_MATRIX.md).
