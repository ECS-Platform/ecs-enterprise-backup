...
- **Remote/Oracle/Windows/NGINX connectors** are not implemented (shown truthfully as Connector Missing) — tracked in `docs/03-development/production/ECS_REMOTE_CONNECTOR_EXPANSION_PLAN.md`.
