...
- KPIs: [KPI Validation Report](../../04-testing/testing/ECS_KPI_VALIDATION_REPORT.md), [Master KPI Dictionary](../../01-product/product/ECS_MASTER_KPI_DICTIONARY.md).
...
### 4.1 Principle
Every KPI must answer *"what decision does this enable?"* Target: **≤4 primary KPI cards + ≤1 secondary row** per page; **≥70% reduction** in visible KPI density. (Current dashboards present large KPI walls — see [KPI Validation Report](../../04-testing/testing/ECS_KPI_VALIDATION_REPORT.md) for the full inventory.)
...
## Cross-references
- [Screen Validation Report](../../04-testing/testing/ECS_SCREEN_VALIDATION_REPORT.md) · [Navigation Audit](ECS_NAVIGATION_AUDIT.md) · [KPI Validation Report](../../04-testing/testing/ECS_KPI_VALIDATION_REPORT.md) · [Master Product Manual](../../01-product/product/ECS_MASTER_PRODUCT_MANUAL.md) · [Master Use Case Registry](../../01-product/product/ECS_MASTER_USE_CASE_REGISTRY.md)
