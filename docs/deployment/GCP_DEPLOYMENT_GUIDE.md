...
> - Container/runtime + generic K8s/HA/DR: [`../architecture/ecs_deployment_architecture.md`](../architecture/ecs_deployment_architecture.md)
> - Enterprise topology + security zones: [`../architecture/ENTERPRISE_ARCHITECTURE.md`](../architecture/ENTERPRISE_ARCHITECTURE.md)
...
- Provision **Cloud SQL for PostgreSQL** (private IP). Apply the ECS schema —
  see [`../architecture/ECS_DATA_ARCHITECTURE_REFERENCE.md`](../architecture/ECS_DATA_ARCHITECTURE_REFERENCE.md)
...
- CI workflows exist: `.github/workflows/ci.yml`,
  ...
  [CI/CD & release notes](#ci) below and the [Testing Guide](../testing/TESTING_GUIDE.md).
...
- `Makefile` targets (`make ci`, `make test`, `make smoke`, `make compile`) mirror
  the CI gates — see [`../00-start-here/COMMON_COMMANDS.md`](../00-start-here/COMMON_COMMANDS.md).
...
- [`../architecture/ecs_deployment_architecture.md`](../architecture/ecs_deployment_architecture.md)
