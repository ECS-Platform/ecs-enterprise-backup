...
> (query engine), [README_DEVELOPER.md](README_DEVELOPER.md) (env/Docker),
> [UAT_ASSET_DRIVEN_SCHEDULER_DESIGN.md](UAT_ASSET_DRIVEN_SCHEDULER_DESIGN.md)
> (asset routing), [ECS_DEVELOPER_ONBOARDING_GUIDE.md](ECS_DEVELOPER_ONBOARDING_GUIDE.md).
...
([design](UAT_ASSET_DRIVEN_SCHEDULER_DESIGN.md)) then classifies an Aerospike
