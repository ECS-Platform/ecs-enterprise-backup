...
Full design: [UAT_ASSET_DRIVEN_SCHEDULER_DESIGN.md](UAT_ASSET_DRIVEN_SCHEDULER_DESIGN.md).
...
- [UAT_ASSET_DRIVEN_SCHEDULER_DESIGN.md](UAT_ASSET_DRIVEN_SCHEDULER_DESIGN.md) — full design.
- [ASSET_DISCOVERY_GUIDE.md](ASSET_DISCOVERY_GUIDE.md) — asset discovery & fingerprinting.
- [TECHNOLOGY_MAPPING_GUIDE.md](TECHNOLOGY_MAPPING_GUIDE.md) — technology → control → framework.
- [INTEGRATION_ADAPTERS_GUIDE.md](INTEGRATION_ADAPTERS_GUIDE.md) — the 11 connectors.
