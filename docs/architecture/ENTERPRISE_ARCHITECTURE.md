...
> - GCP provisioning detail: [`../deployment/GCP_DEPLOYMENT_GUIDE.md`](../deployment/GCP_DEPLOYMENT_GUIDE.md)
...
See [`00-start-here/ARCHITECTURE_OVERVIEW.md`](../00-start-here/ARCHITECTURE_OVERVIEW.md)
...
- The DB Agent depends on **no** enterprise security infrastructure to run (mTLS,
  ...
  [`../developer-manual/DATABASE_AGENT_GUIDE.md`](../developer-manual/DATABASE_AGENT_GUIDE.md).
- The ECS platform's own security framework (auth/RBAC/OIDC) is separate and
  unaffected — see [`../production/ECS_SECURITY_REFERENCE.md`](../production/ECS_SECURITY_REFERENCE.md).
...
documented in [`../operations/PROTOTYPE_DEMO_RUN_MODE.md`](../operations/PROTOTYPE_DEMO_RUN_MODE.md)
...
Reference: [`../operations/PROTOTYPE_DEMO_RUN_MODE.md`](../operations/PROTOTYPE_DEMO_RUN_MODE.md)
· [`../production/ECS_SECURITY_REFERENCE.md`](../production/ECS_SECURITY_REFERENCE.md)
· [`../production/ECS_SSO_OIDC_IMPLEMENTATION_PLAN.md`](../production/ECS_SSO_OIDC_IMPLEMENTATION_PLAN.md).
...
- [`../deployment/GCP_DEPLOYMENT_GUIDE.md`](../deployment/GCP_DEPLOYMENT_GUIDE.md) — GCP provisioning
