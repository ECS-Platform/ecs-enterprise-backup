...
(`observation_generation`). See `docs/scheduler_runtime_flow.md`.
...
- Microsoft Graph specifics: `docs/microsoft_graph_connector_api_reference.md`
- Workbench runtime: `docs/connector_test_workbench_design.md`
- Scheduler runtime: `docs/scheduler_runtime_flow.md`
- Workbench vs scheduler: `docs/test_workbench_vs_scheduler.md`
- Call graph: `docs/runtime_call_graph.md`
- Developer guides: `docs/DEVELOPER/INTEGRATION_ADAPTERS_GUIDE.md`,
  `docs/DEVELOPER/ENTERPRISE_CONNECTOR_UAT_SETUP.md`
- Frontend testing: `docs/connector_frontend_testing_matrix.md`,
  `docs/connector_frontend_manual_testing.md`
