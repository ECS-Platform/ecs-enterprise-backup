...
- Lifecycle workflows: [ECS_USER_JOURNEYS.md](../product_manual/ECS_USER_JOURNEYS.md)
- AI search: [ECS_AI_ARCHITECTURE_REFERENCE.md](../AI/ECS_AI_ARCHITECTURE_REFERENCE.md)
