...
**Grounding:** `config/integrations.yaml` (`sharepoint`), `ecs_platform/ingestion.py`. Part of [Integrations Index](README.md). Interface-complete, `enabled: false` by default. (Demo evidence frequently sourced from "SharePoint Library".)
