...
**Grounding:** `config/integrations.yaml` (`azure_devops`), `ecs_platform/ingestion.py`. Part of [Integrations Index](README.md). Interface-complete, `enabled: false` by default.
