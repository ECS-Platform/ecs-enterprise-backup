...
A concise, code-grounded tour of how ECS is built. Anchored to the actual tree: `app/`, `modules/`, `ecs_platform/`, `config/`. For deep design docs see `docs/architecture/`, `docs/hld/`, `docs/lld/`, and `docs/diagrams/`.
