...
> - Screen-by-screen master: [ECS_MASTER_PRODUCT_MANUAL.md](ECS_MASTER_PRODUCT_MANUAL.md)
> - Functional operations manual + companions: [../product_manual/ECS_PRODUCT_MANUAL.md](../product_manual/ECS_PRODUCT_MANUAL.md)
>   (module, [persona](../product_manual/ECS_PERSONA_GUIDE.md),
>   [screen catalog](../product_manual/ECS_SCREEN_CATALOG.md),
>   [KPI dictionary](../product_manual/ECS_KPI_DICTIONARY.md),
>   [feature reference](../product_manual/ECS_FEATURE_REFERENCE.md),
>   [user journeys](../product_manual/ECS_USER_JOURNEYS.md))
> - Use cases: [ECS_MASTER_USE_CASE_CATALOG.md](ECS_MASTER_USE_CASE_CATALOG.md) · KPIs: [ECS_MASTER_KPI_DICTIONARY.md](ECS_MASTER_KPI_DICTIONARY.md)
> - Developer/architecture: [../DEVELOPER/ECS_DEVELOPER_ONBOARDING_GUIDE.md](../DEVELOPER/ECS_DEVELOPER_ONBOARDING_GUIDE.md)
...
For the leadership framing, see [../DEVELOPER/LEADERSHIP_DEMO_SCRIPT.md](../DEVELOPER/LEADERSHIP_DEMO_SCRIPT.md).
...
| Scheduler (asset-driven) | Plans collection from an asset inventory (dry-run) | CLI + [design](../DEVELOPER/UAT_ASSET_DRIVEN_SCHEDULER_DESIGN.md) |
| Diagnostics | Config-only connector/environment readiness (no live calls) | CLI + `/api/audit/health` |

Deep feature inventory: [../product_manual/ECS_FEATURE_REFERENCE.md](../product_manual/ECS_FEATURE_REFERENCE.md).
...
reference: [../FRAMEWORKS/README.md](../FRAMEWORKS/README.md) and
[../FRAMEWORKS/ECS_FRAMEWORK_REFERENCE.md](../FRAMEWORKS/ECS_FRAMEWORK_REFERENCE.md).
...
to controls. See [../DEVELOPER/TECHNOLOGY_MAPPING_GUIDE.md](../DEVELOPER/TECHNOLOGY_MAPPING_GUIDE.md).
...
and a SHA-256 content hash. See [../DEVELOPER/EVIDENCE_COLLECTION_GUIDE.md](../DEVELOPER/EVIDENCE_COLLECTION_GUIDE.md).
...
See [../DEVELOPER/INTEGRATION_ADAPTERS_GUIDE.md](../DEVELOPER/INTEGRATION_ADAPTERS_GUIDE.md),
[../DEVELOPER/MS_GRAPH_CONNECTOR_GUIDE.md](../DEVELOPER/MS_GRAPH_CONNECTOR_GUIDE.md),
and the master matrix [../INTEGRATIONS/ECS_MASTER_INTEGRATION_MATRIX.md](../INTEGRATIONS/ECS_MASTER_INTEGRATION_MATRIX.md).
...
[../product_manual/ECS_PERSONA_GUIDE.md](../product_manual/ECS_PERSONA_GUIDE.md).
...
[ECS_MASTER_PRODUCT_MANUAL.md](ECS_MASTER_PRODUCT_MANUAL.md) (Group 1) and the
[KPI dictionary](../product_manual/ECS_KPI_DICTIONARY.md).
...
fingerprinted. See [../DEVELOPER/ASSET_DISCOVERY_GUIDE.md](../DEVELOPER/ASSET_DISCOVERY_GUIDE.md).
...
Design + routing table: [../DEVELOPER/UAT_ASSET_DRIVEN_SCHEDULER_DESIGN.md](../DEVELOPER/UAT_ASSET_DRIVEN_SCHEDULER_DESIGN.md).
Operational scheduler (jobs/history/SLA): [../operations/ECS_SCHEDULER_REFERENCE.md](../operations/ECS_SCHEDULER_REFERENCE.md).
...
clear status instead. See [../DEVELOPER/EVIDENCE_COLLECTION_GUIDE.md](../DEVELOPER/EVIDENCE_COLLECTION_GUIDE.md)
and [../DEVELOPER/EVIDENCE_VALIDATION_GUIDE.md](../DEVELOPER/EVIDENCE_VALIDATION_GUIDE.md).
...
[../DEVELOPER/OBSERVATION_AND_REPOSITORY_GUIDE.md](../DEVELOPER/OBSERVATION_AND_REPOSITORY_GUIDE.md).
...
[../DEVELOPER/OBSERVATION_AND_REPOSITORY_GUIDE.md](../DEVELOPER/OBSERVATION_AND_REPOSITORY_GUIDE.md)
and [../operations/ECS_CONTROL_AND_EVIDENCE_REUSE_GUIDE.md](../operations/ECS_CONTROL_AND_EVIDENCE_REUSE_GUIDE.md).
...
[../DEVELOPER/OBSERVATION_AND_REPOSITORY_GUIDE.md](../DEVELOPER/OBSERVATION_AND_REPOSITORY_GUIDE.md)
and the workflow matrices in [../WORKFLOWS/ECS_STATE_TRANSITION_MATRIX.md](../WORKFLOWS/ECS_STATE_TRANSITION_MATRIX.md).
...
- Review UI & actions: [ECS_MASTER_PRODUCT_MANUAL.md](ECS_MASTER_PRODUCT_MANUAL.md) (Governance group, `/evidence/review`).
- State transitions: [../WORKFLOWS/ECS_STATE_TRANSITION_MATRIX.md](../WORKFLOWS/ECS_STATE_TRANSITION_MATRIX.md)
- Role/CRUD matrix: [../WORKFLOWS/ECS_ROLE_ACTION_MATRIX.md](../WORKFLOWS/ECS_ROLE_ACTION_MATRIX.md)
- SLA & escalation: [../WORKFLOWS/ECS_SLA_ESCALATION_MATRIX.md](../WORKFLOWS/ECS_SLA_ESCALATION_MATRIX.md)
- Notifications: [../WORKFLOWS/ECS_NOTIFICATION_MATRIX.md](../WORKFLOWS/ECS_NOTIFICATION_MATRIX.md)
...
[../DEVELOPER/PERFORMANCE_AND_HARDENING_GUIDE.md](../DEVELOPER/PERFORMANCE_AND_HARDENING_GUIDE.md).
...
[../product_manual/ECS_FEATURE_REFERENCE.md](../product_manual/ECS_FEATURE_REFERENCE.md)
and the Reports screen in [ECS_MASTER_PRODUCT_MANUAL.md](ECS_MASTER_PRODUCT_MANUAL.md).

### Notifications
Workflow events (submissions, approvals, rejections, SLA breaches, escalations)
drive notifications per the
[../WORKFLOWS/ECS_NOTIFICATION_MATRIX.md](../WORKFLOWS/ECS_NOTIFICATION_MATRIX.md).

---

## 16. Troubleshooting

> Deep runbooks: [../TROUBLESHOOTING_GUIDE.md](../TROUBLESHOOTING_GUIDE.md),
> [../operations/CONNECTOR_TROUBLESHOOTING_RUNBOOK.md](../operations/CONNECTOR_TROUBLESHOOTING_RUNBOOK.md),
> [../operations/ECS_SUPPORT_RUNBOOK.md](../operations/ECS_SUPPORT_RUNBOOK.md).
...
with no code change. See [../DEVELOPER/UAT_INTEGRATION_GUIDE.md](../DEVELOPER/UAT_INTEGRATION_GUIDE.md).
...
[../DEVELOPER/PRODUCTION_READINESS_GAP_REGISTER.md](../DEVELOPER/PRODUCTION_READINESS_GAP_REGISTER.md):
...
- **In-memory stores by default** — a DB-ready durable persistence foundation
  ...
  ([persistence guide](../DEVELOPER/AUDIT_INTELLIGENCE_PERSISTENCE_GUIDE.md)).
