...
**Type:** Master product documentation. **No code/UI/DB changes.** **Grounding:** route registrars, module engines, `docs/product_manual/*`, `docs/AUDIT/*`. This manual is the **single entry point** to every ECS screen; deep per-screen detail (inputs/actions/exports) lives in [`docs/product_manual/ECS_SCREEN_CATALOG.md`](../product_manual/ECS_SCREEN_CATALOG.md) and screenshots in [`docs/product_manual/screenshots/`](../product_manual/screenshots) — cross-referenced here to avoid duplication.
...
**Per-screen attributes** (Purpose · Navigation · Persona · Business Value · Inputs · Outputs · KPIs · Drilldowns · Reports · Dependencies · Data Sources · APIs · Workflow Participation · Audit/Compliance/Executive Relevance) are tabulated below; the cross-referenced [Feature Inventory](../AUDIT/ECS_PRODUCT_FEATURE_INVENTORY.md) carries Inputs/Outputs/Data/Drilldowns and the [Screen Catalog](../AUDIT/ECS_SCREEN_CATALOG.md) carries Route/Dependencies/Doc/Screenshot.
...
66 screens are captured under [`docs/product_manual/screenshots/`](../product_manual/screenshots) and indexed in [`ECS_SCREENSHOTS_INDEX.md`](../product_manual/ECS_SCREENSHOTS_INDEX.md). Forms, path-param, and redirect routes are documented but not separately imaged (see [Screen Catalog audit](../AUDIT/ECS_SCREEN_CATALOG.md)).

## Related references

- KPIs → [ECS_MASTER_KPI_DICTIONARY.md](ECS_MASTER_KPI_DICTIONARY.md)
- Workflows → [ECS_USER_JOURNEYS.md](../product_manual/ECS_USER_JOURNEYS.md)
