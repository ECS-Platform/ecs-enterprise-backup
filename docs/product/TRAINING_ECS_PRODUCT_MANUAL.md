...
**Audience:** new joiners, product managers, demo teams. **Goal:** understand *what ECS is, why it exists, and what it does* in one read. This is the training-grade product manual; the exhaustive reference is `docs/product/PRODUCT_MANUAL_ECS_PRODUCT_MANUAL.md`.
...
Executive Overview · Frameworks · Operations · Governance · Evidence Governance (repo-backed) · Enterprise GRC · AI SDLC Governance. Deep reference: `docs/product/ECS_MODULE_REFERENCE.md`.
...
- Start: `docs/00-start-here/DEMO_MODE_SETUP.md` → open `/dashboard/cio`.
