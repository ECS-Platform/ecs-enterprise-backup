...
personas, 0 failures), screenshots (`docs/product/screenshots/`), module
reference (`docs/product/ECS_MODULE_REFERENCE.md`), AI pack (`docs/AI/`),
...
`docs/use-cases/ECS_PHASE1_IMPLEMENTATION_BACKLOG.md`.
