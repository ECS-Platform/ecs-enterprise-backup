...
## J. AI (UC-AI01..AI11) — see [AI Catalog V2](../ai-sdlc/ECS_LOCAL_LLM_USE_CASE_CATALOG_V2.md) for 100+
...
## Cross-references
- Screens: [ECS_MASTER_PRODUCT_MANUAL.md](../product/ECS_MASTER_PRODUCT_MANUAL.md) · KPIs: [ECS_MASTER_KPI_DICTIONARY.md](../product/ECS_MASTER_KPI_DICTIONARY.md) · AI use cases: [Catalog V2](../ai-sdlc/ECS_LOCAL_LLM_USE_CASE_CATALOG_V2.md) · Journeys: [User Journeys](../product/ECS_USER_JOURNEYS.md)
