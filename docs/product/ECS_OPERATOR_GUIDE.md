...
| Reset DB | per `docs/operations/RECOVERY_RUNBOOK.md` |
...
Full table: `docs/00-start-here/TROUBLESHOOTING_GUIDE.md` and `docs/operations/ecs_runbook.md`.
...
- Demo broken → run validator, check `/healthz`, review `docs/archive/ECS_DEMO_READINESS_REPORT.md` checklist.
