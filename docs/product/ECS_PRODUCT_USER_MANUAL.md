...
> - Developer/architecture: [../DEVELOPER/ECS_DEVELOPER_ONBOARDING_GUIDE.md](../developer-manual/ECS_DEVELOPER_ONBOARDING_GUIDE.md)
...
| Scheduler (asset-driven) | Plans collection from an asset inventory (dry-run) | CLI + [design](../scheduler/UAT_ASSET_DRIVEN_SCHEDULER_DESIGN.md) |
...
to controls. See [../DEVELOPER/TECHNOLOGY_MAPPING_GUIDE.md](../developer-manual/TECHNOLOGY_MAPPING_GUIDE.md).
...
and a SHA-256 content hash. See [../DEVELOPER/EVIDENCE_COLLECTION_GUIDE.md](../evidence-management/EVIDENCE_COLLECTION_GUIDE.md).
...
See [../DEVELOPER/INTEGRATION_ADAPTERS_GUIDE.md](../connectors/INTEGRATION_ADAPTERS_GUIDE.md),
[../DEVELOPER/MS_GRAPH_CONNECTOR_GUIDE.md](../graph-api/MS_GRAPH_CONNECTOR_GUIDE.md),
and the master matrix [../INTEGRATIONS/ECS_MASTER_INTEGRATION_MATRIX.md](../connectors/ECS_MASTER_INTEGRATION_MATRIX.md).
...
fingerprinted. See [../DEVELOPER/ASSET_DISCOVERY_GUIDE.md](../scheduler/ASSET_DISCOVERY_GUIDE.md).
...
Design + routing table: [../DEVELOPER/UAT_ASSET_DRIVEN_SCHEDULER_DESIGN.md](../scheduler/UAT_ASSET_DRIVEN_SCHEDULER_DESIGN.md).
...
clear status instead. See [../DEVELOPER/EVIDENCE_COLLECTION_GUIDE.md](../evidence-management/EVIDENCE_COLLECTION_GUIDE.md)
and [../DEVELOPER/EVIDENCE_VALIDATION_GUIDE.md](../evidence-management/EVIDENCE_VALIDATION_GUIDE.md).
...
[../DEVELOPER/OBSERVATION_AND_REPOSITORY_GUIDE.md](../evidence-management/OBSERVATION_AND_REPOSITORY_GUIDE.md).
...
[../DEVELOPER/OBSERVATION_AND_REPOSITORY_GUIDE.md](../evidence-management/OBSERVATION_AND_REPOSITORY_GUIDE.md)
and [../operations/ECS_CONTROL_AND_EVIDENCE_REUSE_GUIDE.md](../evidence-management/ECS_CONTROL_AND_EVIDENCE_REUSE_GUIDE.md).
...
[../DEVELOPER/OBSERVATION_AND_REPOSITORY_GUIDE.md](../evidence-management/OBSERVATION_AND_REPOSITORY_GUIDE.md)
and the workflow matrices in [../WORKFLOWS/ECS_STATE_TRANSITION_MATRIX.md](../architecture/ECS_STATE_TRANSITION_MATRIX.md).
...
- State transitions: [../WORKFLOWS/ECS_STATE_TRANSITION_MATRIX.md](../architecture/ECS_STATE_TRANSITION_MATRIX.md)
- Role/CRUD matrix: [../WORKFLOWS/ECS_ROLE_ACTION_MATRIX.md](../architecture/ECS_ROLE_ACTION_MATRIX.md)
- SLA & escalation: [../WORKFLOWS/ECS_SLA_ESCALATION_MATRIX.md](../architecture/ECS_SLA_ESCALATION_MATRIX.md)
- Notifications: [../WORKFLOWS/ECS_NOTIFICATION_MATRIX.md](../architecture/ECS_NOTIFICATION_MATRIX.md)
...
[../DEVELOPER/PERFORMANCE_AND_HARDENING_GUIDE.md](../production/PERFORMANCE_AND_HARDENING_GUIDE.md).
...
[../WORKFLOWS/ECS_NOTIFICATION_MATRIX.md](../architecture/ECS_NOTIFICATION_MATRIX.md).
...
- **In-memory stores by default** — a DB-ready durable persistence foundation
  ...
  ([persistence guide](../audit-intelligence/AUDIT_INTELLIGENCE_PERSISTENCE_GUIDE.md)).
