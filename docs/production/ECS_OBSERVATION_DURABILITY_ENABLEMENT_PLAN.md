...
> **This is an ENABLEMENT plan** — the durable write-through store already exists and is wired into `app/main.py`, gated by `OBSERVATIONS_DURABLE_ENABLED` (default FALSE). See companion: [Observation Workflow Implementation Plan](../use-cases/ECS_OBSERVATION_WORKFLOW_IMPLEMENTATION_PLAN.md).
...
## Cross-references
- [Observation Workflow Plan](../use-cases/ECS_OBSERVATION_WORKFLOW_IMPLEMENTATION_PLAN.md) · [Production Master Plan](../production/ECS_PRODUCTION_READINESS_MASTER_PLAN.md) · [Data Architecture](../architecture/ECS_DATA_ARCHITECTURE_REFERENCE.md)
