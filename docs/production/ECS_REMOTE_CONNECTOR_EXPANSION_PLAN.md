...
- Populated per-env target lists (`predefined_query_targets`) — see [Predefined Query Plan](../use-cases/ECS_PREDEFINED_QUERY_IMPLEMENTATION_PLAN.md).
...
## Cross-references
- [Predefined Query Implementation Plan](../use-cases/ECS_PREDEFINED_QUERY_IMPLEMENTATION_PLAN.md) · [Connector Activation Plan](../use-cases/ECS_CONNECTOR_ACTIVATION_PLAN.md) · [Production Master Plan](../production/ECS_PRODUCTION_READINESS_MASTER_PLAN.md) · [Final Roadmap](../production/ECS_FINAL_PRODUCTION_ROADMAP.md)
