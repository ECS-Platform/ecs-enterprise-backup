...
- Developer setup: `docs/DEVELOPER/MS_GRAPH_CONNECTOR_GUIDE.md`,
  `docs/DEVELOPER/ENTERPRISE_CONNECTOR_UAT_SETUP.md`
- UAT testing: `docs/microsoft_graph_sharepoint_teams_uat_testing.md`
- Per-connector reference: `docs/enterprise_connector_api_reference.md`
- Workbench: `docs/connector_test_workbench_design.md`
- Scheduler: `docs/scheduler_runtime_flow.md`
