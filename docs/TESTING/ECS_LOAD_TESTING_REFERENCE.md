...
- **AI:** offload heavy/long-context jobs to cloud provider (hybrid) per [LLM Decision Matrix](../AI/ECS_LOCAL_VS_CLOUD_LLM_DECISION_MATRIX.md).
- **Caching:** add KPI result caching (Redis) for large tenants — **[Phase 2 enhancement]**.

## Cross-references
- Deployment scaling: [ECS_DEPLOYMENT_REFERENCE.md](../DEPLOYMENT/ECS_DEPLOYMENT_REFERENCE.md)
- AI operations: [ECS_LOCAL_LLM_OPERATIONS_GUIDE.md](../operations/ECS_LOCAL_LLM_OPERATIONS_GUIDE.md)
